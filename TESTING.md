...
4. Export the form definition and confirm the copy says responses and webhook
   URLs are omitted.
5. Import the definition as a draft and confirm it has zero responses.
6. Create a blank form, change the title and description, save it, and publish
   it.
7. Open the live public runner, submit one test response, and return to the
   studio.
8. Select the test response, delete it, and confirm the response count returns
   to zero.
9. Check the Operations panel and confirm the data directory points at your
...
rejection, and response cleanup.
